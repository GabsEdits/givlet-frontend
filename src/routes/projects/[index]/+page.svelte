...
<Paper activeTab="home">
	...
	"
			...
			<div class="flex flex-col md:flex-row gap-6 md:gap-2 w-full">
				<div
				...
				<div
					class="flex flex-col gap-2 items-center bg-givlet-paper dark:bg-givlet-paper-800 border border-white dark:border-white/10 shadow-xl py-5 px-8 rounded-2xl w-full md:w-[50%]"
				>
			...
			<div class="flex flex-col md:flex-row gap-6 md:gap-2">
				<div
					class="flex items-center flex-col gap-2 bg-givlet-paper dark:bg-givlet-paper-800 border border-white dark:border-white/10 shadow-xl py-5 px-8 rounded-2xl w-full md:w-[60%]"
				>
